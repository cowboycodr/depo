...
<a
  {href}
  draggable="false"
  class="group relative flex h-6 select-none items-center gap-1 rounded-md pl-2 pr-2 text-ui-md text-fg-muted no-underline transition-opacity hover:bg-surface-hover hover:text-fg-secondary data-[active=true]:bg-surface-nav-active data-[active=true]:text-fg-bright data-[active=true]:shadow-ring"
